...
RUN mkdir /gen_xmpp_service/
COPY gen_xmpp_service /gen_xmpp_service/
COPY setup.py /
COPY README.md /
RUN find /gen_xmpp_service/ -name "*.editorconfig" -type f -exec rm -Rf {} \;
