...
'''
 ...
 Info
     Defined class GenXMPPServiceSetup with attribute(s) and method(s).
...
try:
    from gen_xmpp_service.pro.read_template import ReadTemplate
    from gen_xmpp_service.pro.write_template import WriteTemplate
...
class GenXMPPServiceSetup(FileChecking):
    '''
        Defined class GenXMPPServiceSetup with attribute(s) and method(s).
        Generate module file generator_test.py by template and parameters.
        It defines:
            ...
            :methods:
                ...
                | __str__ - dunder method for GenGen_xmpp_service.
    '''

    GEN_VERBOSE = 'GEN_XMPP_SERVICE::PRO::GEN_SETUP'
    ...
    def __init__(self, verbose=False):
        ...
        verbose_message(GenXMPPServiceSetup.GEN_VERBOSE, verbose, 'init setup')
    ...
    def gen_setup(self, pro_name, verbose=False):
        ...
        verbose_message(
            GenXMPPServiceSetup.GEN_VERBOSE, verbose,
    ...
    def __str__(self):
        '''
            Dunder method for GenGen_xmpp_service.
