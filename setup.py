...
"""
 ...
 Copyright
     ...
     gen_xmpp_service is free software: you can redistribute it and/or
     modify it under the terms of the GNU General Public License as published
     by the Free Software Foundation, either version 3 of the License, or
     (at your option) any later version.
     gen_xmpp_service is distributed in the hope that it will be useful,
 ...
 Info
     Define setup for tool gen_xmpp_service.
"""
...
__copyright__ = 'Copyright 2020, https://vroncevic.github.io/gen_xmpp_service'
...
setup(
    name='gen_xmpp_service',
    version='1.0.0',
    description='Generating XMPP Modules',
    author='Vladimir Roncevic',
    author_email='elektron.ronca@gmail.com',
    url='https://vroncevic.github.io/gen_xmpp_service',
    license='GPL 2020 Free software to use and distributed it.',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    keywords='Unix, Linux, Development, XMPP, Modules',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=['gen_xmpp_service', 'gen_xmpp_service.pro'],
    install_requires=['ats-utilities'],
    package_data={
        'gen_xmpp_service': [
            'conf/gen_xmpp_service.logo',
            'conf/gen_xmpp_service.cfg',
            'conf/gen_xmpp_service_util.cfg',
            'conf/project.yaml',
            'conf/template/generator_test.template',
            'log/gen_xmpp_service.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/gen_xmpp_service_run.py')
        ]
    )]
)
